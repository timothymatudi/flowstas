...
const features = [
  ...
  { icon: MailCheck, href: '/auth/sign-up', tint: 'bg-primary/10 text-primary', title: 'Capture messages', description: 'Your contact form saves every enquiry to your dashboard and emails you the moment one arrives.' },
  { icon: BarChart3, href: '/auth/sign-up', tint: 'bg-primary/10 text-primary', title: 'See your visitors', description: 'A simple view count per site in your dashboard, so you know what people are looking at.' },
  { icon: Lock, href: '/auth/sign-up', tint: 'bg-primary/10 text-primary', title: 'Password-protect it', description: 'Put a password on any site for client previews, drafts or private pages.' },
